...
.then(()=>{
    console.log("The Username & Password is Correct")
})
.catch((err)=>{
    console.log("The Username & Password is Incorrect",err)
})
...
db.sequelize.sync({force : false}).then(()=>{  //to rename/add database table make it true,
